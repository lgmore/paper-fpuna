...
% Title.
% ------
\title{OPTIMIZACIÓN MULTIOBJETIVO PARA LA MEJORA DEL CONTRASTE Y MINIMIZACIÓN DE LA DISTORSIÓN BASADA EN LOS PARÁMETROS DE CLAHE}
%\title{OPTIMIZACIÓN MULTIOBJETIVO PARA LA MEJORA DEL CONTRASTE BASADA EN CLAHE.}
%
% Single address.
% ---------------
\name{Luis G. Moré, Marcos A. Brizuela, José Luis Vázquez, Diego Pinto-Roa, Horacio Legal Ayala\thanks{Thanks to XYZ agency for funding.}}
